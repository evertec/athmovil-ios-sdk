...
@interface CheckoutEditViewController ()

@end

@implementation CheckoutEditViewController

+(CheckoutEditViewController*)initFromStoryboard {
    UIStoryboard *storyboard = [UIStoryboard storyboardWithName:@"Edit" bundle:nil];
    CheckoutEditViewController *myViewController = [storyboard instantiateViewControllerWithIdentifier:@"CheckoutEditViewController"];
