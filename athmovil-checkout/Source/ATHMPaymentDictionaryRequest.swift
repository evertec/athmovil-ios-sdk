//
//  ATHMPaymentDictionaryRequest.swift
//  athmovil-checkout
//
...
@objc(ATHMPaymentDictionaryRequest)
public class ATHMPaymentDictionaryRequest: NSObject{
     ...
     */
    @objc public func pay(handler: ATHMPaymentHandlerDictionary){
